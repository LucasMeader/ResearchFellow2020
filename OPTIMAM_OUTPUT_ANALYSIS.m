% function [contrast, CNR, SNR] = OPTIMAM_OUTPUT_ANALYSIS(x, y)
...
% CALCULATE MEAN FOR EACH 10x10 MEASUREMENT POINT
externalMean10x10_N = mean(AlExternal10x10_N,'all');
externalMean10x10_E = mean(AlExternal10x10_E,'all');
externalMean10x10_S = mean(AlExternal10x10_S,'all');
externalMean10x10_W = mean(AlExternal10x10_W,'all');

% CALCULATE MEAN FOR EACH 3x3 MEASUREMENT POINT
externalMean3x3_N = mean(AlExternal3x3_N, 'all');
externalMean3x3_E = mean(AlExternal3x3_E, 'all');
externalMean3x3_S = mean(AlExternal3x3_S, 'all');
externalMean3x3_W = mean(AlExternal3x3_W, 'all');
